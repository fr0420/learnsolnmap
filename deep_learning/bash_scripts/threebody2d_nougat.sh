...
export DATA_DIR=$PROJECT_ROOT/data1/3body-2d/version2/max_Dt=1e1_min_Dt=-1e1_filtered

# python3 ../src/train.py debug=runtime &

# python3 ../src/train.py experiment=threebody2d_fixedstep trainer.devices=[0] 

python3 ../src/train.py experiment=threebody2d_idenf trainer.devices=[0] 
# python3 ../src/train.py experiment=threebody2d_idenf trainer.devices=[1] resume_from_ckpt=/workspace/projects_rui/learnsolnmap/deep_learning/logs/train/runs/20241114-213427_6qt7le/checkpoints/latest-epoch00081.ckpt &
