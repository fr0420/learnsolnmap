...
function parse_commandline()
    ...
    @add_arg_table! s begin
        ...
        "--use_float64x4"
            ...
            action = :store_true
        "--no_additive"
            help = "do not use additive correction"
            action = :store_true
        "--fpu_omega"
...
function main()
    ...
    with_additive = !parsed_args["no_additive"]
    ...
    config = OrderedDict(
        ...
        "niters"=>niters, "with_additive"=>with_additive,
    ...
    Lambda = (p, q) -> construct_z(p, q; kwargs...)

    Theta = (p, q, Omega) -> recover_canonical_vars(Omega * construct_z(p, q; kwargs...), q; kwargs...)
